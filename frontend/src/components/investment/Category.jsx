...
const listCompany = [
  { id: '1', name: 'Company', introduce: 'Top company' },
  { id: '2', name: 'Company', introduce: 'Top company' },
  { id: '3', name: 'Company', introduce: 'Top company' },
  { id: '4', name: 'Company', introduce: 'Top company' },
  { id: '5', name: 'Company', introduce: 'Top company' },
]
        ...
        {listCompany.map(e =>
          <div key={e.id} className="flex justify-between w-[1200px] px-4 py-4 border rounded-lg">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <h4 className="font-semibold">{e.name + ' ' + e.id}</h4>
                <p>{e.introduce}</p>
              </div>
            </div>
            <div className="flex items-center">
