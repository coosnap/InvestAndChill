...
public class ValuationChungKhoanDTO extends ValuationDTO{
	//Table report
		private Double roe;
		private Double loiNhuanRong;
		private Double vonChuSoHuu;
		
	public ValuationChungKhoanDTO(String stockCode, String quarter, String year,LocalDateTime date,Double marketcap, Double pe,Double evebitda,Double pb,Double ps,Double roe, Double loiNhuanRong, Double vonChuSoHuu) {
