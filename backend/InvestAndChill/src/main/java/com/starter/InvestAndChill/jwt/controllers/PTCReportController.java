...
public class PTCReportController {
	...
	public ResponseEntity<?> perf1(@PathVariable String stock) {
		List<PTCReport> listReport = new ArrayList<PTCReport>();
		listReport	=	ptcRepository.findByStockForPerf(stock,pageable);
		List<Perf1Response> list = listReport.stream()
                .map(report -> {
	...
	public ResponseEntity<?> perf2(@PathVariable String stock) {
		List<PTCReport> listReport = new ArrayList<PTCReport>();
		listReport	=	ptcRepository.findByStockForPerf(stock,pageable);
	...
	public ResponseEntity<?> perf3(@PathVariable String stock) {
		List<PTCReport> listReport = new ArrayList<PTCReport>();
		listReport	=	ptcRepository.findByStockForPerf(stock,pageable);
	...
	public ResponseEntity<?> perf4(@PathVariable String stock) {
		List<PTCReport> listReport = new ArrayList<PTCReport>();
		listReport	=	ptcRepository.findByStockForPerf(stock,pageable);
	...
	public ResponseEntity<?> perf5(@PathVariable String stock) {
		List<PTCReport> listReport = new ArrayList<PTCReport>();
		listReport	=	ptcRepository.findByStockForPerf(stock,pageable);
	...
	public ResponseEntity<?> bal1(@PathVariable String stock) {
		List<PTCReport> listReport = new ArrayList<PTCReport>();
		listReport	=	ptcRepository.findByStockForPerf(stock,pageable);
	...
	public ResponseEntity<?> bal2(@PathVariable String stock) {
		List<PTCReport> listReport = new ArrayList<PTCReport>();
		listReport	=	ptcRepository.findByStockForPerf(stock,pageable);
	...
	public ResponseEntity<?> bal3(@PathVariable String stock) {
		List<PTCReport> listReport = new ArrayList<PTCReport>();
		listReport	=	ptcRepository.findByStockForPerf(stock,pageable);
	...
	public ResponseEntity<?> bal4(@PathVariable String stock) {
		List<PTCReport> listReport = new ArrayList<PTCReport>();
		listReport	=	ptcRepository.findByStockForPerf(stock,pageable);
	...
	public ResponseEntity<?> bal5(@PathVariable String stock) {
		List<PTCReport> listReport = new ArrayList<PTCReport>();
		listReport	=	ptcRepository.findByStockForPerf(stock,pageable);
	...
	public ResponseEntity<?> cf1(@PathVariable String stock) {
		List<PTCReport> listReport = new ArrayList<PTCReport>();
		listReport	=	ptcRepository.findByStockForPerf(stock,pageable);
	...
	public ResponseEntity<?> cf2(@PathVariable String stock) {
		List<PTCReport> listReport = new ArrayList<PTCReport>();
		listReport	=	ptcRepository.findByStockForPerf(stock,pageable);
	...
	public ResponseEntity<?> other1(@PathVariable String stock) {
		List<PTCReport> listReport = new ArrayList<PTCReport>();
		listReport	=	ptcRepository.findByStockForPerf(stock,pageable);
	...
	public ResponseEntity<?> other2(@PathVariable String stock) {
		List<PTCReport> listReport = new ArrayList<PTCReport>();
		listReport	=	ptcRepository.findByStockForPerf(stock,pageable);
